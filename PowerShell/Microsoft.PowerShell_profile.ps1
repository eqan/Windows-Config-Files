...
oh-my-posh --init --shell pwsh --config "C:\Users\Eqan Ahmad\Documents\PowerShell\ohmyposhv3.json" | Invoke-Expression
...
Set-Alias lvim 'C:\Users\Eqan Ahmad\.local\bin\lvim.ps1'
