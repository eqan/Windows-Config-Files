environment = !('update_url' in chrome.runtime.getManifest()) ? 'development' : 'production';
...
function start(tab) {
  ...
  if (environment === 'development') {
    initCode = [
                "var extensionRootTabId = '" + tab.id + "';",
                "var extensionId = '" + chrome.runtime.id + "';",
                "var extensionPath = '" + chrome.extension.getURL("/").replace(/\/$/, "") + "';",
                "(function() {",
                "  pfstyle = 'lbk';",
                "  pfMod = false;",
