...
var dark_mode_main = {
    ...
    */
    ...
    cs: {
        ...
        'tweetdeck.twitter.com': false,
        'ext-twitch.tv': 'twitchVideos'
    },
    /**
    ...
    append_css_element: function() {
        ...
        var link = document.createElement("link"),
            ...
            href2= chrome.runtime.getURL('css/universal.css');
        ...
        link2.setAttribute("id", "dma-universal-css");
        link2.setAttribute("class", "dmn-custom-append-data");
    ...
    remove_link_object: function () {
        var link    = document.getElementById('dma-temp-global-css'),
            link2   = document.getElementById('dma-universal-css');
        if (link) {
    ...
    */
        ...
        if (current_color && current_color != this.blank_color) {
            if (! (current_color in this.curr_obj)) {
                ...
                if (sum_color >= '740') {
                    ...
                    curr_opacity    = 0.90;
                } else if (sum_color > '0' && sum_color < '80') {
                    curr_opacity    = 1;
                } else {
                    return;
                }
    ...
    trigger_status_change: function(changes, namespace) {
        chrome.storage.local.get({'mode_status':'on','document_brightness':55,'whitelist':{},'lock_brightness': 'off','automode_timing':{'start_time':'08:00','end_time':'06:00'}},function (data) {
