import { WEBSITE_URL, API_URL, BROWSER_TYPE } from "./config-module.js";
...
async function captureTab() {
  return browser.tabs.captureVisibleTab(undefined, { format: "jpeg", quality: 100 })
}
 ...
 * @returns The response from the cloud vision API
 */
...
/**
 * Call the Google Cloud Vision API with the data URI extracted from the video frame image
